...
4. generate and edit hpp-mainnet-node-config.json
...
<pre class="language-bash"><code class="lang-bash">docker run --rm -it \
<strong>  --name hpp-node-sepolia \
</strong>  -v ./hpp-sepolia-node-config.json:/config/nodeConfig.json \
